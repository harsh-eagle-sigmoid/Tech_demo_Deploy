...
Generates 2,500 query-SQL pairs for agent training and evaluation
"""
import json
import random
...
class GroundTruthGenerator:
    """Generate ground truth query-SQL pairs"""
...
if __name__ == "__main__":
    logger.add("logs/ground_truth_generation.log", rotation="10 MB")

    print("🤖 Ground Truth Generator")
    print("=" * 80)
    print("\nGenerating 2,500 query-SQL pairs...")
    print("\nTarget Distribution:")
    print("  - Spend Agent: 1,500 queries (60%)")
    print("  - Demand Agent: 1,000 queries (40%)")
    ...
    spend_queries = generator.generate_queries("spend", 1500)

    # Generate Demand Agent queries
    print("\n📦 DEMAND AGENT (Supply Chain/Demand Forecasting)\n")
    demand_queries = generator.generate_queries("demand", 1000)
