...
# Assuming .env is loaded by config.settings
...
def test_heuristic_eval():
    ...
    # Use real table: spend_data.orders
    # Use real columns: product_id, sales
    ...
    result = evaluator.evaluate(
        ...
        ground_truth_sql=None # Trigger Heuristic
    )
    ...
    # Test Query 2: Invalid SQL (Structural Fail)
    logger.info("\nTesting Invalid SQL...")
    ...
    if result_fail["scores"].get("structural") == 0.0:
        ...
        logger.error("Test 2 Failed (Did not catch structural error)!")
